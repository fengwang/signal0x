...
namespace signal0x
{
    ...
    public:
        ...
        template< typename... F >
        const connection_type connect( const priority_type w, const F&... f )
        { 
        ...
        template< typename... F >
        const connection_type connect(  const F&... f ) //if priority parameter not given, set it to the lowest
